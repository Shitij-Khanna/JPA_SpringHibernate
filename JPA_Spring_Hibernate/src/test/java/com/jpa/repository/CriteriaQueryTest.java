...
public class CriteriaQueryTest {
	...
	public void all_courses() {
		...
		// criteria builder is used for building a query internally, like adding a where
		// or from condition. Also define the expected result, here it is Course.class
		CriteriaBuilder cb = em.getCriteriaBuilder();
		CriteriaQuery<Course> cq = cb.createQuery(Course.class);

		// 2. Define roots for tables which are involved in the query
		// defining from which tables/tables we are getting the data from, in Root
